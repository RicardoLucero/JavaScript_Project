...
function placeXOrO(squareNumber) {
    ...
    //the .some() method is used to check eack element of selectedSquare array
    ...
    if(!selectedSquares.some(element=> element.includes(squareNumber))) {
        ...
        checkWinConditions();
        //This condition is for vhanging the active player.
        if (activePlayer === 'X') {
